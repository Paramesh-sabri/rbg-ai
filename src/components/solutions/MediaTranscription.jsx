import mediatrans from "../../assets/media-trans.png"
...
export default function MediaTranscription(){
    return(
        <div>
                ...
                <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight">
                        Turbocharge multimedia content with one powerful
                        <br />
                        <span className="text-blue-600">Speech to Text API</span>
                    </h1>

                    <p className="mt-6 max-w-xl text-base sm:text-lg text-slate-600 leading-relaxed">
                        Caption, summarize, and analyze podcasts and videos affordably
                        and efficiently using RBG.AI’s high-accuracy speech-to-text and
                        language intelligence APIs.
                    </p>
                    ...
                    <img
                        src={mediatrans}
                        alt="Multimedia speech to text visualization"
